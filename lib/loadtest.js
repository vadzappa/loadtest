...
var urlsGenerator = require('../lib/urlsGenerator');
...
function HttpClient(operation, params)
{
	...
	function init()
	{
		options = urlsGenerator.initiate(params.url);
		options.headers = {};
		if (params.headers)
		{
	...
	self.makeRequest = function()
	{
		...
		var lib = http;
		if (params.follow) {
			options.path = urlsGenerator.nextPath();
		}
	...
	function getConnect(id, callback)
	{
		return function(connection)
		{
			...
			urlsGenerator.consumeResponse(connection);
